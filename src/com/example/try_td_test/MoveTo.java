...
import com.example.try_gameengine.map.AStarFinder;
...
public class MoveTo {
	...
	public void onLoad() {
		...
		if (!original.getFrame().contains(endLocation.x(), endLocation.y())) {
	...
	public void start(ALayer target) {
//		super.start(target);
		original = target;
	...
	public void update(long elapsedTime) {
		...
		original.setPosition(startX, startY);
	}
